	...
	<div class="mod-dict">
		...
		<div class="tool-header">
			<el-form :inline="true" :model="condition" @keyup.enter.native="getDataList()">
				...
				<el-form-item>
					<el-input v-model="condition.sellerCode" placeholder="商家编码" clearable size="mini"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" ref="multipleTable" style="width: 100%;">
			...
			<el-table-column prop="fullName" v-if="showlist.fullName" header-align="center" width="110px" align="center" label="商家全称">
			</el-table-column>
	...
	export default {
		...
		methods: {
			...
			editHandle() {
				...
				sessionStorage.setItem('happySellerId', this.dataListSelections[0].uuid)
				this.$router.push({
					path: 'sale-happySellerEdit'
				})
			},
			deleteHandle() {
				if(this.dataListSelections.length === 0) {
