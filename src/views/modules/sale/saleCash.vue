<template>
	<div class="mod-dict">
		...
		<el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" ref="multipleTable" style="width: 100%;">
			...
			<el-table-column prop="sellerName" header-align="center" align="center" width="180" label="商家名称">
			</el-table-column>
      <el-table-column prop="sellerCode" header-align="center" align="center" label="商家编码" width="80" >
      </el-table-column>
			<el-table-column prop="userId" header-align="center" align="center" label="会员编码"  width="85" >
			</el-table-column>
			<el-table-column prop="userName" header-align="center" align="center" label="会员昵称"  width="120" >
			</el-table-column>
			<el-table-column prop="historyAmount" header-align="center" align="center" label="账户余额"  width="90" >
			</el-table-column>
			<el-table-column prop="amount" header-align="center" align="center" label="提现金额" width="90" >
			</el-table-column>
			...
			<el-table-column prop="createTime" header-align="center" align="center" label="申请时间" width="145">
				<template slot-scope="scope">
			...
			<el-table-column prop="updateTime" header-align="center" align="center" label="审核时间"  width="145">
				<template slot-scope="scope">
			...
			<el-table-column prop="paymentCode" header-align="center" align="center" label="OPENID（交易流水号）" width="200">OPENID
          <template slot-scope="scope">
            <span>{{ scope.row.openId }}</span><br>
            <span>（{{ scope.row.paymentCode }}）</span>
          </template>
			</el-table-column>
			<el-table-column prop="note" header-align="center" align="center" label="备注">
			</el-table-column>
			<el-table-column prop="" header-align="center" align="center" label="操作"  width="90">
				<template slot-scope="scope">
	...
	export default {
		...
		methods: {
			...
			getDataList() {
				...
				this.$http({
					url: this.$http.adornUrl("/sale/saleSellerCashApply/list"),
					method: "post",
			...
			passHandle(uuid) {
				...
				this.$http.post(this.$http.adornUrl("/sale/saleSeller/cashOutExamine"), formData)
					.then(({
						data
					}) => {
						if(data && data.code === 0) {
			...
			refuseHandle(){
				...
				this.$http.post(this.$http.adornUrl("/sale/saleSeller/cashOutRefuse"), formData)
					.then(({
						data
					}) => {
						if(data && data.code === 0) {
