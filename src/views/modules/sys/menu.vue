<template>
	<div class="mod-menu">
		...
		<el-table :data="dataList" row-key="menuId" border style="width: 100%; ">
			...
			<el-table-column prop="showStatus" header-align="center" align="center" width="150" :show-overflow-tooltip="true" label="显示状态">
				<template slot-scope="scope">
					<el-tag v-if="scope.row.type === 0" size="small" type="success">显示</el-tag>
					<el-tag v-else-if="scope.row.type === 1" size="small" type="info">隐藏</el-tag>
				</template>
			</el-table-column>
